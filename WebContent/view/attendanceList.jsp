	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">
			...
			时间：<input id="date"
				...
				class="easyui-datebox" name="date" /> <a id="search-btn"
			...
			<table cellpadding="8">
				<tr>
					...
					<td colspan="3"><input id="add_studentList"
						...
						name="studentid"
						data-options="required:true, missingMessage:'请选择学生'" /></td>
				...
				<tr>
					...
					<td colspan="3"><input id="add_typeList"
						style="width: 200px; height: 30px;" class="easyui-textbox"
						name="type" data-options="required:true, missingMessage:'请选择类型'" />
					</td>
					<td style="width: 80px"></td>
				</tr>
			</table>
